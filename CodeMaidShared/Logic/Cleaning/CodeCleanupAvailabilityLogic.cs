...
namespace SteveCadwallader.CodeMaid.Logic.Cleaning
{
    ...
    internal class CodeCleanupAvailabilityLogic
    {
        ...
        private readonly Lazy<EditorFactory> _editorFactory = new Lazy<EditorFactory>(() => new EditorFactory());
        ...
        /// </summary>
        private EditorFactory EditorFactory => _editorFactory.Value;
        ...
        private bool IsFileNameExcludedByOptions(string filename)
        {
            ...
            {
                OutputWindowHelper.WarningWriteLine($"Invalid regex expression found in cleaning exclusions options: {ex.Message}");
                return false;
            }
        }
        ...
        private bool IsFileNameIncludedByOptions(string filename)
        {
            ...
            else
            {
                ...
                {
                    OutputWindowHelper.WarningWriteLine($"Invalid regex expression found in cleaning inclusions options: {ex.Message}");
                    return true;
                }
            }
        }
